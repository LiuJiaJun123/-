				...
				<div class="row data-type">
					...
					<div class="col-md-4 data">
						<input type="text" class="form-control"
							value="${book.book_id }" readonly="readonly">
					</div>

					<div class="col-md-2 title">书籍名称</div>
					<div class="col-md-4 data">
						<input type="text" class="form-control"
							   value="${book.book_name }" readonly="readonly">
					</div>
					...
					<div class="col-md-4 data">
						<input type="text" class="form-control"
							   value="${book.statusStr }" readonly="readonly">
					</div>

					<div class="col-md-2 title rowHeight2x">图片</div>
					<div class="col-md-4 rowHeight2x" >
							<img class="img-responsive" src="${book.imgUrl}" alt="Photo" style="height: 4.5vw;">
					</div>
