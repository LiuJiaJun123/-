			...
			<!-- 内容头部 /-->
				...
				<div class="box box-primary">
					...
					<div class="box-body">
						...
						<div class="table-box">
								...
								<div class="form-group form-inline">
									<div class="btn-group">
										<button type="button" class="btn btn-default" title="新建"
												onclick="location.href='/pages/announcement-add.jsp'">
							...
							<div class="box-tools pull-right">
                                <form action="${pageContext.request.contextPath}/announcement/findAnnouncement.do" method="post">
							...
							<form id="form1" action="${pageContext.servletContext.contextPath}/announcement/delete.do" method="post">
								<!--数据列表-->
								<table id="dataList"
									...
									<thead>
										<tr>
                                            ...
                                            <th class="sorting_asc sorting_asc_disabled">公告标题</th>
									...
									<tbody>
										...
										<c:forEach items="${announcementInfo.list}" var="announcement">
											<tr>
												...
												<td><input type="checkbox" name="selectIds" value="${announcement.announcement_id}"></td>
												<td>${announcement.announcement_id }</td>
												<td>${announcement.userInfo.username }</td>
												<td>${announcement.title }</td>
												<td>${announcement.statusStr }</td>
												<td class="text-center">
													<a href="${pageContext.request.contextPath}/announcement/beforeDetail.do?announcement_id=${announcement.announcement_id}" class="btn bg-olive btn-xs">详情</a>
													<a href="${pageContext.request.contextPath}/announcement/edit.do?announcement_id=${announcement.announcement_id}" class="btn bg-olive btn-xs">编辑</a>
												</td>
											</tr>
										</c:forEach>
									</tbody>
					...
					<div class="box-footer">
						<div class="pull-left">
							<div class="form-group form-inline">
								总共${announcementInfo.pages} 页，共${announcementInfo.total} 条数据。
