			...
			<!-- 内容头部 /-->
				...
				<div class="box box-primary">
						...
						<div class="table-box">
							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										<button type="button" class="btn btn-default" title="新建" onclick="location.href='/pages/category-add.jsp'">
							...
							<div class="box-tools pull-right">
                                <form action="${pageContext.request.contextPath}/category/findCategory.do" method="post">
                                    <div class="has-feedback">
                                        <%--搜索--%>
                                        <input type="text" class="form-control input-sm" placeholder="输入类别名称搜索" name="username" id="username">
							...
							<form id="form1" action="${pageContext.servletContext.contextPath}/category/delete.do" method="post">
								<!--数据列表-->
								<table id="dataList"
									...
									<tbody>
										...
										<c:forEach items="${categoryInfo.list}" var="category">
											<tr>
													<%-- checkbox 提交form，所以要有name ,value为要删除的id--%>
												<td><input type="checkbox" name="selectIds" value="${category.category_id}"></td>
												<td>${category.category_id }</td>
												<td>${category.category_name }</td>
												<td class="text-center">
													<a href="${pageContext.request.contextPath}/category/edit.do?category_id=${category.category_id}" class="btn bg-olive btn-xs">编辑</a>
												</td>
											</tr>
										</c:forEach>
									</tbody>
					...
					<div class="box-footer">
						<div class="pull-left">
							<div class="form-group form-inline">
								总共${categoryInfo.pages} 页，共${categoryInfo.total} 条数据。
