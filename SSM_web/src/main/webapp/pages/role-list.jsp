			...
			<!-- 内容头部 /-->
				...
				<div class="box box-primary">
						...
						<div class="table-box">
							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										<button type="button" class="btn btn-default" title="新建" onclick="location.href='${pageContext.request.contextPath}/role/findAllPermission.do'">
							...
							<form id="form1" action="${pageContext.servletContext.contextPath}/role/delete.do" method="post">
								<!--数据列表-->
								<table id="dataList"
									...
									<tbody>
										...
										<c:forEach items="${pageInfo.list}" var="role">
											<tr>
												...
												<td><input type="checkbox" name="selectIds" value="${role.id}"></td>
												<td>${role.id }</td>
												<td>${role.roleName }</td>
												<td>${role.roleDesc }</td>
					...
					<div class="box-footer">
						...
						<div class="box-tools pull-right">
							<ul class="pagination">
								<li><a aria-label="Previous" href="${pageContext.request.contextPath}/role/findAll.do?page=1&pageSize=${pageInfo.pageSize}">首页</a></li>
								...
								<c:forEach begin="1" end="${pageInfo.pages}" var="i">
									<c:if test="${i==pageInfo.pageNum}">
										<li><a style="background-color: #2aabd2" href="${pageContext.request.contextPath}/role/findAll.do?page=${i}&pageSize=${pageInfo.pageSize}">${i}</a></li>
									</c:if>
									<c:if test="${i!=pageInfo.pageNum}">
										<li><a href="${pageContext.request.contextPath}/role/findAll.do?page=${i}&pageSize=${pageInfo.pageSize}">${i}</a></li>
									</c:if>
								</c:forEach>
