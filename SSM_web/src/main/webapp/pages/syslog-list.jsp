...
<body class="hold-transition skin-blue sidebar-mini">
			...
			<div class="box box-primary">
				...
				<div class="box-footer">
					...
					<div class="box-tools pull-right">
						<ul class="pagination">
							<li>
								<a aria-label="Previous" href="${pageContext.request.contextPath}/sysLog/findAll.do?page=1&pageSize=${pageInfo.pageSize}">首页</a>
							</li>
							...
							<c:forEach begin="${begin}" end="${end}" var="i">
								<c:if test="${i==pageInfo.pageNum}">
									<li><a style="background-color: #2aabd2" href="${pageContext.request.contextPath}/sysLog/findAll.do?page=${i}&pageSize=${pageInfo.pageSize}">${i}</a></li>
								</c:if>
								<c:if test="${i!=pageInfo.pageNum}">
	...
	<script>
        ...
        $(document).ready(function() {
            ...
            // 激活导航位置
            setSidebarActive("syslog-management");
