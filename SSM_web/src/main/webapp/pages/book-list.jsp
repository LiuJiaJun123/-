	...
	<div class="wrapper">
				...
				<div class="box box-primary">
						...
						<div class="table-box">
							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										<button type="button" class="btn btn-default" title="新建" onclick="location.href='/pages/book-add.jsp'">
							...
							<div class="box-tools pull-right">
                                <form action="${pageContext.request.contextPath}/book/findBook.do" method="post">
                                    <div class="has-feedback">
                                        <%--搜索--%>
                                        <input type="text" class="form-control input-sm" placeholder="输入书籍名称搜索" name="book_name" id="book_name">
					...
					<div class="box-footer">
						...
						<div class="box-tools pull-right">
							<ul class="pagination">
								<li>
									<a aria-label="Previous" href="${pageContext.request.contextPath}/book/findAll.do?page=1&pageSize=${bookInfo.pageSize}">首页</a>
								</li>
								<li><a href="${pageContext.request.contextPath}/book/findAll.do?page=${bookInfo.pageNum-1}&pageSize=${bookInfo.pageSize}">上一页</a></li>

								<c:forEach begin="1" end="${bookInfo.pages}" var="i">
									<c:if test="${i==bookInfo.pageNum}">
										<li><a style="background-color: #2aabd2" href="${pageContext.request.contextPath}/book/findAll.do?page=${i}&pageSize=${bookInfo.pageSize}">${i}</a></li>
									</c:if>
									<c:if test="${i!=bookInfo.pageNum}">
										<li><a href="${pageContext.request.contextPath}/book/findAll.do?page=${i}&pageSize=${bookInfo.pageSize}">${i}</a></li>
									</c:if>
								</c:forEach>

								<li><a href="${pageContext.request.contextPath}/book/findAll.do?page=${bookInfo.pageNum+1}&pageSize=${bookInfo.pageSize}">下一页</a></li>
								<li>
									<a href="${pageContext.request.contextPath}/book/findAll.do?page=${bookInfo.pages}&pageSize=${bookInfo.pageSize}" aria-label="Next">尾页</a>
								</li>
							</ul>
						</div>
		...
		<script>
            ...
            function changPageSize(){
                ...
                location.href="${pageContext.request.contextPath}/book/findAll.do?page=1&pageSize="+pageSize;
            }
