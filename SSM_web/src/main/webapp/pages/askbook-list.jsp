					...
					<div class="box-body">
						...
						<div class="table-box">
								...
								<div class="form-group form-inline">
									<div class="btn-group">
										<button type="button" class="btn btn-default" title="新建"
												onclick="location.href='${pageContext.request.contextPath}/askbook/findAllCategory.do'">
							...
							<div class="box-tools pull-right">
                                <form action="${pageContext.request.contextPath}/askbook/findAskBook.do" method="post">
                                    <div class="has-feedback">
                                        <%--搜索--%>
                                        <input type="text" class="form-control input-sm" placeholder="输入求购书籍名称、求购人名称、类别名称搜索"
                                               style="width: 20vw; " name="findConditions" id="findConditions">
							...
							<form id="form1" action="${pageContext.servletContext.contextPath}/askbook/delete.do" method="post">
								<!--数据列表-->
								<table id="dataList"
										...
										<c:forEach items="${askbookInfo.list}" var="askbook">
											<tr>
												...
												<td class="text-center">
													<a href="${pageContext.request.contextPath}/askbook/beforeDetail.do?askbook_id=${askbook.askbook_id}" class="btn bg-olive btn-xs">详情</a>
													<a href="${pageContext.request.contextPath}/askbook/edit.do?askbook_id=${askbook.askbook_id}" class="btn bg-olive btn-xs">编辑</a>
												</td>
											</tr>
										</c:forEach>
									</tbody>
