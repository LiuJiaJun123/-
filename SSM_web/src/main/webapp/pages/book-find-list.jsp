	...
	<div class="wrapper">
				...
				<div class="box box-primary">
					...
					<div class="box-body">
						...
						<div class="table-box">
								...
								<div class="form-group form-inline">
									<div class="btn-group">
										<button type="button" class="btn btn-default" title="新建"
												onclick="location.href='${pageContext.request.contextPath}/book/findAllCategory.do'">
							...
							<form id="form1" action="${pageContext.servletContext.contextPath}/book/delete.do" method="post">
								<!--数据列表-->
								<table id="dataList"
									...
									<tbody>
										...
										<c:forEach items="${bookInfo.list}" var="book">
											<tr>
												...
												<td>${book.categoryInfo.category_name }</td>
					...
					<div class="box-footer">
						...
						<div class="box-tools pull-right">
							<ul class="pagination">
								<li>
									<a aria-label="Previous" href="${pageContext.request.contextPath}/book/findBook.do?findConditions=${findConditions}&page=1&pageSize=${bookInfo.pageSize}">首页</a>
								</li>
								<li><a href="${pageContext.request.contextPath}/book/findBook.do?findConditions=${findConditions}&page=${bookInfo.pageNum-1}&pageSize=${bookInfo.pageSize}">上一页</a></li>

								<c:forEach begin="1" end="${bookInfo.pages}" var="i">
									<c:if test="${i==bookInfo.pageNum}">
										<li><a style="background-color: #2aabd2" href="${pageContext.request.contextPath}/book/findBook.do?findConditions=${findConditions}&page=${i}&pageSize=${bookInfo.pageSize}">${i}</a></li>
									</c:if>
									<c:if test="${i!=bookInfo.pageNum}">
										<li><a href="${pageContext.request.contextPath}/book/findBook.do?findConditions=${findConditions}&page=${i}&pageSize=${bookInfo.pageSize}">${i}</a></li>
									</c:if>
								</c:forEach>

								<li><a href="${pageContext.request.contextPath}/book/findBook.do?findConditions=${findConditions}&page=${bookInfo.pageNum+1}&pageSize=${bookInfo.pageSize}">下一页</a></li>
								<li>
									<a href="${pageContext.request.contextPath}/book/findBook.do?findConditions=${findConditions}&page=${bookInfo.pages}&pageSize=${bookInfo.pageSize}" aria-label="Next">尾页</a>
								</li>
							</ul>
						</div>
		...
		<script>
            ...
            function changPageSize(){
                ...
                location.href="${pageContext.request.contextPath}/book/findBook.do?findConditions=${findConditions}&page=1&pageSize="+pageSize;
            }
