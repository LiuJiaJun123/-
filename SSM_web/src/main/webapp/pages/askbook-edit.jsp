...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<ol class="breadcrumb">
				...
				<li class="active">求购书籍信息编辑</li>
			</ol>
			</section>
			<!-- 内容头部 /-->

            <%--enctype="multipart/form-data"--%>
			<form action="${pageContext.request.contextPath}/askbook/update.do" id="updateForm"
				method="post" enctype="multipart/form-data">
				<!-- 正文区域 -->
				<section class="content"> <!--产品信息-->

				<div class="panel panel-default">
					<div class="panel-heading">求购书籍信息</div>
					<div class="row data-type">

						<div class="col-md-2 title">求购书籍编号</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="askbook_id"
								   value="${askbookInfo.askbook_id }" readonly="readonly">
						</div>

						<div class="col-md-2 title">求购人ID</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="userInfo.id"
								   value="${askbookInfo.userInfo.id }" readonly="readonly">
						</div>

						<div class="col-md-2 title">求购书籍名称</div>
						<div class="col-md-4 data">
                            <input id="askbook_name" type="text" class="form-control" name="askbook_name"
                                 placeholder="求购书籍名称" value="${askbookInfo.askbook_name}">
						</div>
						<div class="col-md-2 title">求购书籍作者</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="author"
								   placeholder="求购书籍作者" value="${askbookInfo.author}">
						</div>

                        <div class="col-md-2 title">类别</div>
                        <div class="col-md-4 data">
							<select class="form-control select2" style="width: 100%" name="categoryInfo.category_id">
								<option value="${askbookInfo.categoryInfo.category_id}" selected>${askbookInfo.categoryInfo.category_name}</option>
								<c:forEach items="${categoryNotSet}" var="category">
									<option value="${category.category_id}">${category.category_name}</option>
								</c:forEach>
							</select>
                        </div>
                        <div class="col-md-2 title">求购书籍成色</div>
                        <div class="col-md-4 data">
							<select class="form-control select2" style="width: 100%"
									name="appearance">
								<c:if test="${askbookInfo.appearance=='无说明'}">
								...
								<c:if test="${askbookInfo.appearance=='9成新'}">
								...
								<c:if test="${askbookInfo.appearance=='8成新'}">
									<option value="无说明">请选择</option>
									<option value="9成新">9成新</option>
								...
								<c:if test="${askbookInfo.appearance=='7成新'}">
									<option value="无说明">请选择</option>
									<option value="9成新">9成新</option>
									<option value="8成新">8成新</option>
								...
								<c:if test="${askbookInfo.appearance=='6成新'}">
									<option value="无说明">请选择</option>
									<option value="9成新">9成新</option>
									<option value="8成新">8成新</option>
									<option value="7成新">7成新</option>
								...
								<c:if test="${askbookInfo.appearance=='5成新'}">
									<option value="无说明">请选择</option>
									<option value="9成新">9成新</option>
									<option value="8成新">8成新</option>
									<option value="7成新">7成新</option>
								...
								<c:if test="${askbookInfo.appearance=='4成新'}">
									<option value="无说明">请选择</option>
									<option value="9成新">9成新</option>
									<option value="8成新">8成新</option>
									<option value="7成新">7成新</option>
								...
								<c:if test="${askbookInfo.appearance=='3成新'}">
									<option value="无说明">请选择</option>
									<option value="9成新">9成新</option>
									<option value="8成新">8成新</option>
									<option value="7成新">7成新</option>
								...
								<c:if test="${askbookInfo.appearance=='2成新'}">
									<option value="无说明">请选择</option>
									<option value="9成新">9成新</option>
									<option value="8成新">8成新</option>
									<option value="7成新">7成新</option>
								...
								<c:if test="${askbookInfo.appearance=='1成新'}">
									<option value="无说明">请选择</option>
									<option value="9成新">9成新</option>
									<option value="8成新">8成新</option>
									<option value="7成新">7成新</option>
						...
						<div class="col-md-2 title">求购时间</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="time"
								   value="<fmt:formatDate value='${askbookInfo.time}' pattern='yyyy-MM-dd HH:mm'/>" readonly="readonly">
						</div>
						...
						<div class="col-md-4 data">
							<select class="form-control select2" style="width: 100%"
								name="status">
								<c:if test="${askbookInfo.status==0}">
									<option value="0" selected="selected">关闭</option>
									<option value="1">开启</option>
								</c:if>

								<c:if test="${askbookInfo.status==1}">
						...
						<div class="col-md-2 title rowHeight2x">求购书籍图片</div>
						<div class="col-md-4 rowHeight2x" >
							<%--<input type="file" id="imgUrl" name="imgUrl" ONCHANGE="setImg(this);">--%>
							<%--没有图片--%>
							<c:if test="${askbookInfo.imgUrl=='../img/暂无图片.png'}">
							...
							<%--已有图片--%>
							<c:if test="${askbookInfo.imgUrl !='../img/暂无图片.png'}">
								<img class="img-responsive" src="${askbookInfo.imgUrl}" alt="Photo" style="height: 4.5vw;float: left;">
                        ...
                        <div class="col-md-2 title rowHeight2x">描述</div>
                            ...
                            <textarea class="form-control" rows="3"
                                      name="description">${askbookInfo.description}</textarea>
                        </div>
	...
	<script>
        ...
        $(document).ready(function() {
            ...
            // 激活导航位置
            setSidebarActive("askbook-management");
