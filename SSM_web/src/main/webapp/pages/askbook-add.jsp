	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<ol class="breadcrumb">
				...
				<li class="active">添加求购书籍</li>
			</ol>
			</section>
			<!-- 内容头部 /-->

            <%--enctype="multipart/form-data"--%>
			<form action="${pageContext.request.contextPath}/askbook/save.do" id="saveForm"
					...
					<div class="row data-type">
						...
						<div class="col-md-4 data">
                            <input id="askbook_name" type="text" class="form-control" name="askbook_name"
                                 placeholder="求购书籍名称" value="">
						</div>
						<div class="col-md-2 title">求购书籍作者</div>
						<div class="col-md-4 data">
							<input type="text" class="form-control" name="author"
								   placeholder="求购书籍作者" value="">
						</div>

                        <div class="col-md-2 title">求购人</div>
                        <div class="col-md-4 data">
